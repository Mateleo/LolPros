...
<template>
  <main
    class="bg-[#22262B] p-3 md:px-5 px-2 flex flex-col w-[95%] m-auto mt-0 max-w-[900px] min-w-[400px]"
  >
    ...
    <div class="bg-[#292E35] p-2 px-5">
      ...
      >
        ...
        <div
          class="rounded-full py-1 w-[60px] text-center font-semibold text-sm"
          :class="user.diff.toString()[0] != '-' ? ['bg-green-500'] : ['bg-red-500']"
        >
